// Matheus Gouvêa Ramalho - TP05 - Q01 - Pesquisa Binária
...
// Pesquisa Binária por ID
    ...
    public static void main(String[] args) {
        ...
        try (PrintWriter log = new PrintWriter(new FileWriter(matricula + "_binaria.txt"))) { 
            log.println("Matrícula:" + matricula + "\t" + "Tempo de execução em ms:" + tempoExecucao + "\t" + "Número de comparações:" + numeroComparacoes);
        } catch (IOException e) {
